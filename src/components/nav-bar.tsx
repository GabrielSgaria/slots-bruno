...
export async function NavBar() {
    ...
    return (
            ...
            <nav className="shadow-xl bg-black border-b border-zinc-900/20 fixed top-0 w-full z-50">
                <div className="container mx-auto flex flex-col items-center justify-center gap-5 py-3 px-2">
                    <div className="flex flex-row gap-2 sm:gap-10 text-lg w-full justify-center items-center">
                        <Link href="/" className=" py-0 text-center justify-center items-center flex text-zinc-950 font-bold rounded-md transition-all duration-200  sm:text-base">
                            <p className="text-zinc-50 hover:underline text-xs sm:text-sm italic">JOGOS PG</p>
                        </Link>
                        ...
                        <Link href="/pp-games" className="py-0 text-center justify-center items-center flex text-zinc-950 font-bold rounded-md transition-all duration-200  sm:text-base">
                            <p className="text-zinc-50 hover:underline text-xs sm:text-sm italic">JOGOS PP</p>
                        </Link>
                        
                        <div className="h-8 border-r border-zinc-50/10"/>
                        <Link href="/gerar-sinais" className="py-0 text-center justify-center items-center flex text-zinc-950 font-bold rounded-md transition-all duration-10  sm:text-base">
                            <p className="text-zinc-50 hover:underline text-xs sm:text-sm italic">GERAR SINAIS</p>
                        </Link>
                        <div className="h-8 border-r border-zinc-50/10"/>
                        {novoLink ? (
