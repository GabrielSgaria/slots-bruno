...
export function CardGames({ linkCasa, id, porcentagem }: CardGamesProps) {
    ...
    return (
        <div key={id} className="flex flex-col my-4 justify-between backdrop-blur-md bg-zinc-950/20 border border-zinc-950/5 shadow-xl shadow-black px-0 pb-3 rounded-3xl max-w-[200px]">
            ...
            <div className='px-2 h-full w-full flex flex-col gap-4 mt-5'>
                <div className={`w-full h-4 rounded-full bg-zinc-50 relative z-10 overflow-hidden`} >
                ...
                <Link href="/gerar-sinais" className="my-2 border border-zinc-50/15 text-center justify-center hover:bg-zinc-50/15 items-center flex font-bold rounded-md transition-all duration-200 text-base sm:text-base">
                    <p className="text-zinc-50 hover:underline">JOGUE AGORA</p>
                </Link>
