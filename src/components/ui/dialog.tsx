    ...
    >
      <div className="relative w-full h-full">
        <DialogPrimitive.Close
          className="absolute flex items-center justify-center right-5 top-5 h-8 w-8 p-0 rounded-full bg-black bg-opacity-50 hover:bg-opacity-75 transition-all z-[1000]"
          onClick={onClose}
        >
        ...
        <div className="absolute inset-0 pointer-events-none z-[60]">
          <Image
            src="/image/natal/dialog-natal.png"
            alt=""
            layout="fill"
            objectFit="contain"
            priority
        ...
        {/* Content Container */}
        <div className="relative z-[50] m-4 bg-background/0 rounded-lg">
          {children}
        </div>
      </div>
    </DialogPrimitive.Content>
